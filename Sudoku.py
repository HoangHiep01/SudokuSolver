...
class Sudoku():
	...
	def isValid(self, row, col, num):
		...
		for i in range(3):
			for j in range(3):
				if self.__matrix[i + startRow][j + startCol] == num:
					return False
	...
	def solveSuduko(self, row, col):
	    ...
	    for num in range(1, self.__size + 1, 1):
